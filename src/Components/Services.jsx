    ...
    <section className="bg-[#ffffff] my-[31px] mx-[31px] py-16 md:py-24 md:px-16 rounded-[50px] ">
      <div className="flex flex-col items-center mx-auto max-w-8xl md:flex-row">
        ...
        <div className="order-2 mx-5 mt-12 md:order-1 md:mt-0 md:w-1/2">
          ...
          <p className="mb-6 text-lg">Our UI/UX design services cover web and mobile app interfaces, ensuring intuitive and visually appealing user experiences. Using tools like Figma and Adobe XD, we create designs that are both user-friendly and engaging, tailored to meet the specific needs of your business and audience.
          </p>
        </div>
      </div>
  </section>
      ...
      <div className="max-w-8xl mx-[auto] flex flex-col md:flex-row items-center">
      <div className="flex justify-center order-1 mt-12 md:w-1/2 md:order-2 md:mt-0">
          <img className="" src={Graphic} /> </div>
        <div className="order-2 mx-5 mt-12 md:w-1/2 md:order-2 md:mt-0">
          <h1 className="text-4xl text-[#0090FF] md:text-6xl font-bold mb-6 uppercase">graphic Designing</h1>
          <p className="mb-6 text-lg">At 
            <span className="font-bold text-blue-600"> TITANCode</span>, our graphic design services encompass social media posts, flyers, banners, logos, labels, packages, tickets, and more. Utilizing Adobe Photoshop, Illustrator, and InDesign, we ensure high-quality, visually appealing designs that effectively communicate your brand's message and captivate your audience.
          </p>
        </div>
      </div>
    </section>
